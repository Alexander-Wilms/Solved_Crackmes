...
int main(void)
{
  ...
  char BYTE_encrypted_password[] = { 0x2c, 0x3c, 0x23, 0x3b, 0x2c, 0x0b, 0x21, 0x3a, 0x2f, 0x3f, 0x65, 0x86, 0xab, 0x79, 0x35, 0x24, 0x0b, 0xf9, 0x86, 0xf1, 0x06, 0x41, 0x00 };
  ...
  while(1) {
    ...
    valid_password[i] = valid_password[i] ^ "SCTL"[i % valid_passwod_length];
    i += 1;
  }
